...
function Page() {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      nni: Yup.string()
        .required("NNI  du fils est requis pour continuer le processus")
        .length(11, "Le numéro NNI doit contenir exactement 11 caractères."),
      nni_pere: Yup.string()
        .required("NNI du pere est requis pour continuer le processus")
        .length(11, "Le numéro NNI doit contenir exactement 11 caractères."),
    }),
    ...
    onSubmit: async (values) => {
          ...
          >
            ...
            <div className="ml-3 mr-12">
              <p className="block font-sans text-base antialiased font-medium leading-relaxed text-inherit">
                Attention ce couple de pere et fils n'existe pas:
              </p>
              <ul className="mt-2 ml-2 list-disc list-inside">
                <li>Veillez nous fournir un couple valide</li>
      ...
      setIsLoading(true);
      await axiosAuthapi
        .get("/verification/fils/" + values.nni + "/" + values.nni_pere)
        .then((res) => {
          setIsLoading(false);
    ...
    <Suspense>
      <>
        <div className="flex flex-col items-center justify-center h-screen dark">
          <div className="w-full max-w-lg bg-gray-700 rounded-lg shadow-lg px-6">
            ...
            <form
              ...
              action={"/formulaire"}
            >
              <div className="grid grid-cols-7 flex-col gap-2">
                <div>
                  <Image
                ...
                <div className="col-span-6">
                  <Input
                    ...
                    type="text"
                    name="nni"
                    placeholder="Entrez le numéro national d'identification du fils"
                    existe={true}
                    longeur={11}
              ...
              <div className="grid grid-cols-7 w-full gap-6">
                <div>
                  <Image
                    className="items-center justify-center  bg-white rounded-sm"
                    width={40}
                    height={40}
                    alt="logo"
                    src="/437532.png"
